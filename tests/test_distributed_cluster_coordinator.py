...
# COMPLIANCE: Sovereign Substrate / test_distributed_cluster_coordinator.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / test_distributed_cluster_coordinator.py
...
class TestIntegration:
    ...
    def test_service_registry_coordination(self):
        ...
        try:
            ...
            # Register services
            coordinator.registry.register_service(coordinator.node_id, "ai-inference")
            coordinator.registry.register_service(coordinator.node_id, "robot-control")
            ...
            # Get node services
            node_services = coordinator.registry.get_node_services(coordinator.node_id)
