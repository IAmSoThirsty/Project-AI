...
class TestGlobalScenarioEngine:
    ...
    def test_build_causal_model(self, engine):
        ...
        econ_to_unemp = [
            l for l in links
            if l.source == RiskDomain.ECONOMIC.value
            and l.target == RiskDomain.UNEMPLOYMENT.value
        ]
    ...
    def test_simulate_scenarios(self, engine):
        ...
        from app.core.simulation_contingency_root import ThresholdEvent, CausalLink
