...
from src.app.core.event_spine import get_event_spine, EventCategory, EventPriority, Event
...
class TestEventSpine(unittest.TestCase):
    ...
    def test_priority_ordering(self):
        ...
        for priority in [EventPriority.DEBUG, EventPriority.LOW, EventPriority.NORMAL, EventPriority.HIGH, EventPriority.CRITICAL]:
            self.spine.publish(
        ...
        expected = [EventPriority.CRITICAL, EventPriority.HIGH, EventPriority.NORMAL, EventPriority.LOW, EventPriority.DEBUG]
...
class TestGovernanceGraph(unittest.TestCase):
    ...
    def test_override_authority(self):
        ...
        self.assertTrue(
            self.graph.can_override("agi_safeguards", "ethics_governance")
        )
