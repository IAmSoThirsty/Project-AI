...
from app.core.identity import GenesisEvent, PersonalityMatrix, AGIIdentity
from app.core.meta_identity import IdentityMilestones, MetaIdentityEngine
from app.core.governance import Triumvirate, GovernanceDecision, GovernanceContext
...
class TestGenesisEvent:
    ...
    def test_genesis_event_uniqueness(self):
        ...
        genesis1 = GenesisEvent(
            prime_directive="Assist ethically",
            creator="user1"
        )
        genesis2 = GenesisEvent(
            prime_directive="Assist ethically",
            creator="user1"
        )
...
class TestPersonalityEvolution:
    ...
    def test_personality_multiple_traits(self):
        ...
        pm = PersonalityMatrix(version=1, traits={
            "confidence": 0.5,
            "empathy": 0.6,
            "caution": 0.4
        })
