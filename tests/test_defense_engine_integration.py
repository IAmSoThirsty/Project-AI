...
from src.app.core.system_registry import SystemRegistry, SubsystemPriority
...
class TestBootstrapIntegration(unittest.TestCase):
    ...
    def test_subsystem_initialization_order(self):
        ...
        class SubsystemA(BaseSubsystem):
            SUBSYSTEM_METADATA = {'id': 'subsystem_a', 'name': 'A', 'version': '1.0.0', 'priority': 'LOW', 'dependencies': [], 'provides_capabilities': [], 'config': {}}
        
        class SubsystemB(BaseSubsystem):
            SUBSYSTEM_METADATA = {'id': 'subsystem_b', 'name': 'B', 'version': '1.0.0', 'priority': 'LOW', 'dependencies': ['subsystem_a'], 'provides_capabilities': [], 'config': {}}
        
        class SubsystemC(BaseSubsystem):
            SUBSYSTEM_METADATA = {'id': 'subsystem_c', 'name': 'C', 'version': '1.0.0', 'priority': 'LOW', 'dependencies': ['subsystem_b'], 'provides_capabilities': [], 'config': {}}
    ...
    def test_health_monitoring(self):
        ...
        class HealthySubsystem(BaseSubsystem):
            SUBSYSTEM_METADATA = {'id': 'healthy', 'name': 'Healthy', 'version': '1.0.0', 'priority': 'LOW', 'dependencies': [], 'provides_capabilities': [], 'config': {}}
