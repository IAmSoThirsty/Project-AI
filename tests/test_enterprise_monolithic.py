...
# COMPLIANCE: Sovereign Substrate / test_enterprise_monolithic.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / test_enterprise_monolithic.py
...
class TestBlackVault:
    ...
    def test_vault_rotation(self, vault_key, temp_vault_dir):
        ...
        vault_store = os.path.join(temp_vault_dir, "test_vault.store")
        vault = BlackVault(
            vault_store=vault_store, max_size=100
            ...
            try:
                cb.call(
                    lambda: (_ for _ in ()).throw(
                        ValueError("Forbidden phrase detected")
                    )
                )
            except ValueError:
                pass
