...
<h1 align="center">⚡ Autonomous Incident Reflex System</h1>
...
Sub-millisecond evidence preservation and reactive policy enforcement. Connects OctoReflex bedrock to high-level governance for autonomous threat containment.
...
cd Autonomous Incident Reflex System
```
...
```bash
# Build image
docker build -t Autonomous Incident Reflex System:latest .

# Run container
docker run -p 8000:8000 \
  -e DATABASE_URL="your-database-url" \
  Autonomous Incident Reflex System:latest
```
...
```bash
kubectl rollout status deployment/Autonomous Incident Reflex System
```

1. **View logs**

```bash
kubectl logs -f deployment/Autonomous Incident Reflex System
```
...
- `service_autonomous_incident_reflex_system_requests_total` - Total requests
- `service_autonomous_incident_reflex_system_request_duration_seconds` - Request latency
- `service_autonomous_incident_reflex_system_requests_inflight` - In-flight requests
- `service_autonomous_incident_reflex_system_db_query_duration_seconds` - Database query latency
