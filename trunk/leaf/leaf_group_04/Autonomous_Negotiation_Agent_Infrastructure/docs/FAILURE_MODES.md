...
<!-- # COMPLIANCE: Sovereign Substrate / FAILURE_MODES.md # -->
<!-- # ============================================================================ # -->
<!-- # ============================================================================ #
...
## Autonomous Negotiation Agent Infrastructure - Comprehensive Failure Analysis
...
**Failure**: Client exceeds rate limit (500 req/min)
...
2. Manual: `kubectl rollout undo deployment/Autonomous Negotiation Agent Infrastructure`
