...
<!-- # COMPLIANCE: Sovereign Substrate / PULL_REQUEST_TEMPLATE.md # -->
<!-- # ============================================================================ # -->
<div align="right">
...
- [ ] Manually tested on multiple browsers
...
- [ ] I have checked my code for accessibility (WCAG 2.1 Level AA)
...
- [ ] Color contrast checked (minimum 4.5:1 for text)
