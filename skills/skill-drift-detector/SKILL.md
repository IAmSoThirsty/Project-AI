...
description: Detect when real usage exceeds a skill intended scope or users rely on unintended behavior.
---
...
Recommend clarification, splitting, retraining, or deprecation before drift becomes institutionalized.
...
Return, as applicable: usage patterns; intended scope; drift; risks; redesign options.
