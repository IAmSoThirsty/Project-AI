---
name: thirsty-work-orchestrator
description: Coordinate end-to-end Thirstys Workshop workflows across context routing, ingestion, synthesis, governance, engineering, research, publication, and hostile review.
---

# Thirsty Work Orchestrator

## Objective

Select and sequence specialist skills, preserve provenance, and keep consequential actions approval-gated.
...
Return, as applicable: execution plan; invoked skills; evidence ledger; outputs; unresolved issues; next call.
