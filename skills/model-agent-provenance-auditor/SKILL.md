---
name: model-agent-provenance-auditor
description: Track what model, instructions, tools, memory, policies, data, and human interventions produced an output.
---

# Model Agent Provenance Auditor

## Objective

Support accountability, reproducibility, and incident reconstruction.
...
Return, as applicable: provenance record; versions; inputs; tool calls; interventions; reproducibility gaps.
