...
description: Coordinate manuscript and release preparation across papers, repositories, metadata, DOI, ORCID, SSRN, Zenodo, and project sites. Use when preparing work for publication.
---
...
Create a reviewable publication package while keeping external writes approval-gated.
...
Return, as applicable: readiness checklist; metadata; abstract/keywords; release notes; cross-platform consistency.
