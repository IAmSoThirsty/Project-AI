...
description: Find incompatible statements across repositories, papers, policies, conversations, and specifications. Use for contradiction, drift, and terminology conflict analysis.
---
...
Distinguish direct contradiction from version drift, scope differences, and intentional pluralism.
...
Return, as applicable: contradiction set; classification; sources; impact; resolution options.
