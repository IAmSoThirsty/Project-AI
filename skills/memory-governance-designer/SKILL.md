---
name: memory-governance-designer
description: Design constitutional rules for agent memory admission, provenance, correction, expiry, access, isolation, inheritance, deletion, and contested records.
---

# Memory Governance Designer

## Objective

Make memory lifecycle and rights enforceable and auditable.
...
Return, as applicable: memory classes; lifecycle rules; access model; correction/deletion; audit requirements.
