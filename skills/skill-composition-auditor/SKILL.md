---
name: skill-composition-auditor
description: Audit whether combining individually acceptable skills creates contradictory, unsafe, circular, or overly powerful workflows.
---

# Skill Composition Auditor

## Objective

Find emergent composition risks and define safe call boundaries.
...
Return, as applicable: call graph; conflicts; privilege amplification; cycles; mitigations.
