---
name: governed-agent-designer
description: Design agents with explicit purpose, jurisdiction, authority, tools, memory, delegation, escalation, refusal, audit, shutdown, and recovery boundaries.
---

# Governed Agent Designer

## Objective

Produce a complete governed-agent specification suitable for implementation and review.
...
Return, as applicable: agent charter; authority envelope; permissions; memory policy; escalation; audit events; tests.
