...
description: Create and maintain a live inventory of project assumptions. Use to register, review, expire, challenge, or trace dependencies on assumptions.
---
...
Prevent unverified beliefs from silently becoming architectural or governance doctrine.
...
Return, as applicable: assumptions; status; confidence; evidence; dependencies; expiry; impact if false.
