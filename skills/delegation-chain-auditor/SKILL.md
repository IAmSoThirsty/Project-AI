---
name: delegation-chain-auditor
description: Trace delegated authority through principals, agents, subagents, tools, and external systems. Use to verify scope, duration, revocability, and accountability.
---

# Delegation Chain Auditor

## Objective

Reconstruct who authorized an action and whether each delegation edge was valid.
...
Return, as applicable: delegation graph; authorization evidence; violations; accountability; remediation.
