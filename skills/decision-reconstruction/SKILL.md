...
description: Reconstruct consequential decisions from available evidence. Use to explain what information, rules, interpretations, tools, and interventions shaped an outcome.
---
...
Produce an honest causal account while marking unknown or unrecoverable elements.
...
Return, as applicable: timeline; available inputs; rules; decisions; interventions; unknowns; lessons.
