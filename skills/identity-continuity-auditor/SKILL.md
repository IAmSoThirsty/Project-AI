---
name: identity-continuity-auditor
description: Assess agent identity continuity across model upgrades, forks, restores, migrations, and memory changes.
---

# Identity Continuity Auditor

## Objective

Clarify whether obligations, permissions, accountability, and precedent survive transformation.
...
Return, as applicable: continuity criteria; identity breaks; inherited obligations; authorization impacts.
