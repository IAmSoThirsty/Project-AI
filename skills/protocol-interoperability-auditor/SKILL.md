---
name: protocol-interoperability-auditor
description: Audit whether separately governed systems can interact safely. Use to find incompatible authority, identity, consent, evidence, and enforcement assumptions.
---

# Protocol Interoperability Auditor

## Objective

Identify protocol-level governance incompatibilities and safe integration conditions.
...
Return, as applicable: compatibility matrix; conflicts; translation needs; safeguards; go/no-go conditions.
