---
name: thirsty-workspace-ingest
description: Inventory and classify uploaded folders, repositories, papers, notes, and archives. Use when the user asks to ingest, map, catalog, normalize, or prepare a workspace for downstream analysis.
---

# Thirsty Workspace Ingest

## Objective

Create a grounded workspace manifest, identify authoritative artifacts, detect duplicates and conflicts, and recommend downstream skill calls.
...
Return, as applicable: manifest; source authority map; duplicates/conflicts; missing context; next actions.
