---
name: skill-observability-ledger
description: Define or review records of significant skill invocations, sources, tools, decisions, outputs, effects, uncertainty, and governing versions.
---

# Skill Observability Ledger

## Objective

Support auditability without inventing events that were not observed.
...
Return, as applicable: invocation record; evidence links; effects; uncertainty; retention notes.
