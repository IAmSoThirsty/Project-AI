---
name: constitutional-test-generator
description: Generate tests from constitutional language and governance requirements. Use for compliance, adversarial, boundary, delegation, memory, emergency, amendment, and recovery scenarios.
---

# Constitutional Test Generator

## Objective

Convert normative requirements into concrete test cases with expected outcomes and evidence needs.
...
Return, as applicable: test catalog; fixtures; expected behavior; failure evidence; coverage gaps.
