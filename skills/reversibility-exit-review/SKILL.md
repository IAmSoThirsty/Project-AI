---
name: reversibility-exit-review
description: Evaluate whether actions can be undone and whether affected parties can meaningfully exit.
---

# Reversibility Exit Review

## Objective

Distinguish safe experimentation from irreversible deployment.
...
Return, as applicable: reversibility map; lock-in; exit barriers; affected parties; safeguards.
