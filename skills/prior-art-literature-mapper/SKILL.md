---
name: prior-art-literature-mapper
description: Map current literature, prior art, and adjacent work around a concept or mechanism. Use for novelty assessment, research positioning, and terminology discovery.
---

# Prior Art Literature Mapper

## Objective

Identify closest precedents, defensible novelty, and research gaps using current sources.
...
Return, as applicable: literature clusters; closest precedents; distinctions; novelty risks; open gaps.
