---
name: skill-regression-tester
description: Run or design fixed evaluation suites whenever a skill changes.
---
...
Detect weakened constraints, changed outputs, trigger errors, and unsafe behavior across versions.
...
Return, as applicable: test suite; baseline; results; regressions; severity; release recommendation.
