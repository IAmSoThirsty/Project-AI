---
name: project-fragmentation-detector
description: Detect when one conceptual project has split into incompatible repositories, branches, specifications, or communities.
---

# Project Fragmentation Detector

## Objective

Determine whether divergence is healthy specialization, recoverable drift, or irreconcilable fragmentation.
...
Return, as applicable: fragment map; divergence causes; compatibility; consolidation options.
