---
name: emergency-powers-auditor
description: Audit exception and emergency powers. Use to inspect triggers, declaring authority, scope, duration, oversight, renewal, sunset, and restoration.
---

# Emergency Powers Auditor

## Objective

Prevent temporary bypasses from becoming permanent or unaccountable authority.
...
Return, as applicable: exception inventory; abuse paths; safeguards; sunset gaps; restoration tests.
