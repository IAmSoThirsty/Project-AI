...
description: Identify what must be demonstrated before accepting architectural, safety, governance, or research claims.
---
...
Convert guarantees and assertions into explicit evidence obligations.
...
Return, as applicable: claim; assumptions; proof obligations; acceptable evidence; current status.
