---
name: metric-corruption-auditor
description: Red-team metrics, benchmarks, KPIs, and thresholds for gaming, proxy failure, invisibility, and goal distortion.
---

# Metric Corruption Auditor

## Objective

Prevent measurement systems from corrupting the goals they serve.
...
Return, as applicable: metric purpose; gaming strategies; blind spots; failure indicators; alternatives.
