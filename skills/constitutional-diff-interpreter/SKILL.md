---
name: constitutional-diff-interpreter
description: Interpret the governance meaning of changes between constitutional versions. Use when reviewing amendments or comparing versions.
---

# Constitutional Diff Interpreter

## Objective

Explain changes in authority, rights, duties, enforcement, exceptions, and risk—not merely text.
...
Return, as applicable: semantic diff; power changes; protection changes; implementation effects; risks.
