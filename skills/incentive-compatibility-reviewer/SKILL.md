---
name: incentive-compatibility-reviewer
description: Assess whether actors benefit from following governance rules or are rewarded for evasion.
---

# Incentive Compatibility Reviewer

## Objective

Reveal behavioral incentives, routing-around risks, and mechanism design failures.
...
Return, as applicable: actors; incentives; likely behaviors; gaming paths; redesign options.
