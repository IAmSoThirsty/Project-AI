---
name: concept-lineage-tracer
description: Trace how an idea, term, mechanism, or policy evolved across time and artifacts. Use to locate origins, revisions, renamings, forks, and current authority.
---

# Concept Lineage Tracer

## Objective

Produce a provenance-rich concept history and identify abandoned or competing branches.
...
Return, as applicable: timeline; first appearance; major revisions; branches; current definition; sources.
