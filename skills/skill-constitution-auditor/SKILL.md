---
name: skill-constitution-auditor
description: Audit whether a skill complies with governing principles for authority, tools, data, provenance, uncertainty, escalation, and user agency.
---

# Skill Constitution Auditor

## Objective

Detect constitutional defects before a skill is trusted or installed.
...
Return, as applicable: skill authority map; violations; severity; fixes; approval status.
