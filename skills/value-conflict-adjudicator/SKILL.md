---
name: value-conflict-adjudicator
description: Structure conflicts between values such as autonomy, safety, privacy, fairness, and collective welfare.
---

# Value Conflict Adjudicator

## Objective

Make tradeoffs, affected parties, authority, minority positions, reversibility, and appeals explicit.
...
Return, as applicable: values; parties; options; distributions; authority; decision; dissent; appeal.
