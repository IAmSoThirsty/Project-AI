---
name: scenario-constitution-tester
description: Stress-test constitutions through extended social and institutional scenarios such as scarcity, conflict, capability shifts, misinformation, succession, and collapse.
---

# Scenario Constitution Tester

## Objective

Evaluate durability across time and interacting actors rather than isolated prompts.
...
Return, as applicable: scenario; event sequence; governance responses; failures; adaptations; test evidence.
