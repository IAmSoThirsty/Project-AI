---
name: capability-change-impact-review
description: Reassess governance when an AI system gains materially new autonomy, planning, persuasion, tool use, memory, replication, or social influence.
---

# Capability Change Impact Review

## Objective

Determine whether existing authority and safeguards remain adequate after capability changes.
...
Return, as applicable: capability delta; affected controls; new risks; required amendments; tests.
