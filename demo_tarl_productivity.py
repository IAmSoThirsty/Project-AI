...
def demo_performance_comparison():
    ...
    print(f"\n📈 Results:")
    print(f"   Non-cached time: {no_cache_time*1000:.2f}ms ({no_cache_time/iterations*1000000:.2f}μs per eval)")
    print(f"   Cached time: {cached_time*1000:.2f}ms ({cached_time/iterations*1000000:.2f}μs per eval)")
    ...
    print(f"   Cache entries: {metrics['cache_info']['size']}/{metrics['cache_info']['maxsize']}")
