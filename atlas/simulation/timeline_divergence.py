...
class TimelineDivergence:
    ...
    first_divergence_year: Optional[int] = None
    first_divergence_magnitude: Optional[float] = None
...
class ProjectionTensor:
    ...
    tensor_hash: Optional[str] = None
    
    def get(self, seed: str, horizon: int, year: int) -> Optional[ProjectionPoint]:
...
def get_timeline_divergence_engine(seeds: Optional[List[str]] = None,
                                   horizons: Optional[List[int]] = None,
