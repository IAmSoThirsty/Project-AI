...
from atlas.governance.constitutional_kernel import get_constitutional_kernel, ConstitutionalViolation
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="ATLAS Ω - Constitutional Probabilistic Civilization Engine",
