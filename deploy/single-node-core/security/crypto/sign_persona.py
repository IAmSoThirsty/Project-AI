...
# COMPLIANCE: Sovereign Substrate / sign_persona.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / sign_persona.py
...
class PersonaSigner:
    ...
    def generate_keypair(self, force: bool = False) -> tuple[Path, Path]:
        ...
        print("✓ Generated Ed25519 keypair for persona signing:")
    ...
    def verify_snapshot(self, snapshot_file: Path) -> tuple[bool, str, dict | None]:
        """
    ...
    def list_snapshots(self, persona_id: str | None = None) -> list[dict]:
        """
    ...
    def restore_snapshot(self, snapshot_file: Path) -> tuple[bool, dict | None]:
        """
