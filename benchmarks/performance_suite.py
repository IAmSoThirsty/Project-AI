...
try:
    ...
    from src.app.security.asymmetric_enforcement_gateway import SecurityEnforcementGateway, OperationRequest, OperationType
except ImportError:
...
class PerformanceBenchmark:
    ...
    def generate_summary(self):
        ...
        print(f"  Temporal fuzzing: Test-only (0% production overhead) ✓")
