...
from src.app.core.god_tier_integration import (
    GodTierIntegratedSystem, initialize_god_tier_system, get_god_tier_system
)
...
def demo_conversation_system(system: GodTierIntegratedSystem):
    ...
    conversations = [
        ...
        ("That's great! What should I wear?", "Light clothing would be appropriate for 75°F weather."),
        ("Thanks for the advice!", "You're welcome! Have a great day!")
    ]
    
    for user_input, system_response in conversations:
        turn = system.context_engine.add_turn(
...
def demo_policy_system(system: GodTierIntegratedSystem):
    ...
    user_id = "demo_user"
    session_id = system.context_engine.start_session(user_id) if system.context_engine else "test_session"
