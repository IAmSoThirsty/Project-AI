...
**Superseding 2026-07-22 workflow submission-state evidence:** The highest-authority Sovereign War Room submission control and durable work-queue request/review controls now disable during in-flight requests and expose operation-specific pending labels, preventing duplicate human records, reviews, or execution-gate submissions while durable receipts are pending. Operator-console component coverage passes 69/69; aggregate web coverage passes 111/111. The full Windows and digest-pinned Linux browser suites remain green at 40/40, and no visual baseline was regenerated.
