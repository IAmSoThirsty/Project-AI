...
- The current branch contains gate-report and documentation follow-ups after the
  ...
  code-candidate evidence above. Follow-up CI `29717900198` and vulnerability
  scan `29717900199` passed for branch head `29757ed7`. Dependabot PRs #509 and #510 remain open against `master`
