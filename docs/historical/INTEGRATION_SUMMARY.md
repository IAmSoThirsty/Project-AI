...
- `docs/historical/TRIUMVIRATE_QUICKSTART.md` - Quick start guide
...
1. `docs/historical/TRIUMVIRATE_QUICKSTART.md` - Quick start (210 lines)
...
1. **docs/historical/TRIUMVIRATE_QUICKSTART.md** (210 lines)
   - 5-minute setup
