...
<!-- # COMPLIANCE: Sovereign Substrate / DATA_INGEST_LICENSE.md # -->
<!-- # ============================================================================ # -->
<div align="right">
...
This license governs all data submitted to, ingested by, or processed through Project-AI systems. It protects both users and Project-AI from data-related liabilities while clarifying rights and responsibilities.
...
- Right to use data beyond service provision

### V. PROJECT-AI OBLIGATIONS
...
- Anonymized data cannot be deleted (no longer personal data)
...
**Exercise rights:** privacy@project-ai.dev
...
- Maximum liability: $0 for Solo tier, service fees paid for other tiers
...
*Protecting your data rights while enabling innovation.*
