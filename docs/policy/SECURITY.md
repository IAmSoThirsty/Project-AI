...
# ❌ BAD: Hardcoded secrets (NEVER do this - example only)
SECRET_KEY = "EXAMPLE_KEY_12345"  # DO NOT use example values
DB_PASSWORD = "EXAMPLE_PASS_123"  # DO NOT use example values
```
