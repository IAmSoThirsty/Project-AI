...
SECRET_KEY = "your-secret-here"  # Example only - DO NOT use real secrets
DB_PASSWORD = "your-password-here"  # Example only - DO NOT use real secrets
PASSWORD = "your-password-here"  # Example only - DO NOT use real secrets
```
