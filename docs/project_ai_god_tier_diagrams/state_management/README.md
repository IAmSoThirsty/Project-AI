...
**Storage:** `data/identity/snapshots/`  
**Format:** JSON with hash verification
...
**Storage:** `data/memory/{episodic,semantic,procedural}/`  
**Format:** Multi-channel JSON records
...
**Component:** AuditLog  
**Storage:** `data/audit_log/{date}.log`  
**Format:** Append-only, hash-chained log entries
...
**Format:** Execution context cache
...
**Component:** GUI Components (PyQt6)  
**Storage:** In-memory with session persistence  
**Format:** Qt model/view state
