...
- [ ] **Triumvirate approval obtained**
  - GALAHAD: ☐ Approved ☐ Rejected (reason: _____________)
  - CERBERUS: ☐ Approved ☐ Rejected (reason: _____________)
  - CODEX: ☐ Approved ☐ Rejected (reason: _____________)
...
- [ ] **Full red-team campaign passed**
  ...
  - Custom scenarios: ___ / ___ tests passed
