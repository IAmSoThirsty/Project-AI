...
2. **Web Frontend** (HTML/CSS/JS) - Any browser
3. **Android App** (Kotlin) - Android 7.0+ (API 24+)
4. **Desktop App** (Electron) - Windows, macOS, Linux
...
2. Tag: `v1.0.0`
3. Title: `Project AI Governance Kernel v1.0.0`
...
2. 🌐 **Web App** → `web-v1.0.0.zip`
3. 📱 **Android** → `project-ai-android-v1.0.0.apk`
4. 💻 **Desktop (Windows)** → `project-ai-governance-1.0.0.exe`
5. 🍎 **Desktop (macOS)** → `project-ai-governance-1.0.0.dmg`
6. 🐧 **Desktop (Linux)** → `project-ai-governance-1.0.0.AppImage`
