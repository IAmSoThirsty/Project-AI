...
1. **`docs/PRODUCTION_RELEASE_GUIDE.md`** - Full production release guide
1. **`scripts/build_release.sh`** - Linux/Mac release builder
1. **`scripts/build_release.bat`** - Windows release builder
...
Users can then download from: `https://github.com/your-repo/releases/download/v1.0.0/project-ai-v1.0.0.zip`
...
1. **Production Release:** `docs/PRODUCTION_RELEASE_GUIDE.md`
...
1. **Quick Reference:** `DEPLOYMENT_RELEASE_QUICKSTART.md`
...
1. Upload `project-ai-v1.0.0.zip`
1. Users download platform-specific builds
