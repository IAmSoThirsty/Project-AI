---
title: "WEB BRANCH SUMMARY"
id: "web-branch-summary"
...
tags:
  ...
  - security
  - architecture
path_confirmed: T:/Project-AI-main/docs/internal/archive/session-notes/WEB_BRANCH_SUMMARY.md
---
...
1. **Shared Core**: Both desktop and web use same core functionality
1. **Independent**: Web version in separate `web/` directory
1. **Ready to Integrate**: Can be merged without breaking existing code
