...
4. **Update the folder's README** if adding a major document
5. **Check for cross-references** and update links in other docs
...
2. **Move the file**: `git mv old/path/file.md new/path/file.md`
3. **Update cross-references**: Search for links to the old path
4. **Update README files**: Update both old and new folder READMEs
5. **Test all links**: Ensure no broken references
...
1. **README.md** (root)
2. **Other documentation files** that link to the moved file
3. **Folder README files**
4. **.github/copilot-instructions.md** (if referenced)
5. **Any code comments** that reference the documentation
...
2. Check the folder README files
3. Look at similar existing documents
4. When in doubt, ask in your PR description
