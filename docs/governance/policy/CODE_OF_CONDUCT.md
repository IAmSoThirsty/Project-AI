...
We are committed to providing a welcoming and inspiring community for all. We pledge that everyone participating in the Project-AI community will be treated with respect and dignity, regardless of age, body size, caste, disability, ethnicity, level of experience, family status, gender identity and expression, marital status, military or veteran status, national origin, personal appearance, political belief, political affiliation, pregnancy status, race, religion, sex, sexual orientation, socioeconomic status, tribal status, or any other dimension of diversity.....
...
- Give and receive feedback with courtesy
...
- Deliberate intimidation, stalking, or doxxing
- Non-consensual photography or recording
- Sustained disruption of community spaces
- Advocating for or encouraging violations of this code
- Abuse of project resources or infrastructure
- Spamming, trolling, or baiting other members
...
- Acknowledging and celebrating the contributions of others
...
1. **Include**:
   ...
   - Who was involved
   - Any witnesses
   - Links or evidence (if applicable)

### Confidentiality

- All reports are handled with appropriate confidentiality
- Investigation details will not be disclosed without consent (except as required)
- Reporters will not be retaliated against for good-faith reports
...
- Treat all communication channels with the same respect as in-person
- Use professional and welcoming language
- Assume good intentions, clarify misunderstandings respectfully
- Report problematic behavior through proper channels

### Contributing Code

- Follow project coding standards
- Be respectful in code review feedback
- Accept constructive criticism of your code
- Focus on the code, not the person
- Help newer contributors learn and improve

### Community Events

- Respect event guidelines and organizer decisions
- Follow all venue policies
...
Project leadership is committed to:

- Enforcing this code consistently
- Being accountable for their own behavior
- Setting an example through their conduct
- Taking reports seriously and acting quickly
...
- **Safety Concerns**: Contact leadership immediately
- **Reporting Issues**: Use the reporting process above
- **Questions**: Comment on this document or ask in discussions
- **Support**: Community members available to help
...
- Discussed with the community when possible
...
By participating in Project-AI, you agree to:
