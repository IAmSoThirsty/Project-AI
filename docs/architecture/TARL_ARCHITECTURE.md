...
<!-- # COMPLIANCE: Sovereign Substrate / TARL_ARCHITECTURE.md # -->
<!-- # ============================================================================ # -->
<!-- # ============================================================================ #

               # -->
<!-- # COMPLIANCE: Sovereign Substrate / TARL System Architecture                  # -->
<!-- # ============================================================================ #
...
This system is architected upon the formal specifications defined in:
* **[[4] Thirsty's Symbolic Compression Grammar (TSCG)](https://doi.org/10.5281/zenodo.18794292)**: Defines the grammar for state encoding.
* **[[7] Project-AI and OCTOREFLEX](https://doi.org/10.5281/zenodo.18726064)**: Establishes the kernel boundary LSM enforcement.
* **[[9] Asymmetric Security Whitepaper](../whitepaper/THIRSTYS_ASYMMETRIC_SECURITY_WHITEPAPER.md)**: Defines the moving-target defense and invariant-driven escalation model.
