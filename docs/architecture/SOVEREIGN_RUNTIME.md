...
<!-- # COMPLIANCE: Sovereign Substrate / SOVEREIGN_RUNTIME.md # -->
<!-- # ============================================================================ # -->
<div align="right">
...
The Sovereign Runtime enforces the constitutional boundaries established in:
* **[[2] AGI Charter for Project-AI (v2.1)](https://doi.org/10.5281/zenodo.18763076)**: Primary constitutional authority.
* **[[6] Constitutional Architectures for Adaptive Intelligence](https://doi.org/10.5281/zenodo.18794646)**: Design of the shadow simulation layer.
* **[[1] The Directness Doctrine](https://doi.org/10.5281/zenodo.19030041)**: Ethical foundation for direct agent behavior.
* **[[9] Asymmetric Security Whitepaper](../../whitepaper/THIRSTYS_ASYMMETRIC_SECURITY_WHITEPAPER.md)**: Implementation of runtime irreducibility and Cerberus governance.
