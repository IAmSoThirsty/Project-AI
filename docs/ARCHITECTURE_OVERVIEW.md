...
2. **Cerberus (Safety/Security):** Protects against technical compromise and systemic risk
3. **Codex Deus Maximus (Logic/Consistency):** Ensures coherence with FourLaws and specifications
...
2. **Then:** [AGI_IDENTITY_SPECIFICATION.md](AGI_IDENTITY_SPECIFICATION.md) - Learn what's protected
3. **Next:** [SECURITY_FRAMEWORK.md](SECURITY_FRAMEWORK.md) - Technical security overview
4. **Finally:** [SECURITY_GOVERNANCE.md](security/SECURITY_GOVERNANCE.md) - Who does what
