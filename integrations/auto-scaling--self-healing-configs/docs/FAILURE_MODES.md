...
# COMPLIANCE: Sovereign Substrate / Integrated Service: auto-scaling--self-healing-configs / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Auto-scaling & self-healing configs - Comprehensive Failure Analysis
...
**Failure**: Client exceeds rate limit (100 req/min)
...
2. Manual: `kubectl rollout undo deployment/Auto-scaling & self-healing configs`
