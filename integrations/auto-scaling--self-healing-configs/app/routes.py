...
# COMPLIANCE: Sovereign Substrate / Integrated Service: auto-scaling--self-healing-configs / routes.py
# ============================================================================ #
"""
API routes
"""
...
async def list_items(
    ...
    """
    logger.info(f"Listing items: page={pagination.page}, page_size={pagination.page_size}")
