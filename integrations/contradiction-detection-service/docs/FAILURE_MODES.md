...
# COMPLIANCE: Sovereign Substrate / Integrated Service: contradiction-detection-service / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Contradiction Detection Service - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Contradiction Detection Service`
