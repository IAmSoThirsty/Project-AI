...
# COMPLIANCE: Sovereign Substrate / test_integration.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / test_integration.py
...
class IntegrationTester:
    ...
    def run_all_tests(self):
        ...
        self.run_test(
            "Integration package exists", self.test_integration_package_exists
        )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Integration test suite for Thirsty-lang + TARL"
    )
