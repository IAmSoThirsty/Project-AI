...
# COMPLIANCE: Sovereign Substrate / Integrated Service: the-epoch-synchronizer / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## The Epoch Synchronizer - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/The Epoch Synchronizer`
