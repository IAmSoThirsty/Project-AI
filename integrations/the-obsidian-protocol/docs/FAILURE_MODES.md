...
# COMPLIANCE: Sovereign Substrate / Integrated Service: the-obsidian-protocol / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## The Obsidian Protocol - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/The Obsidian Protocol`
