...
# COMPLIANCE: Sovereign Substrate / Integrated Service: semantic-drift-monitor / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Semantic Drift Monitor - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Semantic Drift Monitor`
