...
# COMPLIANCE: Sovereign Substrate / Integrated Service: medical-knowledge-service / main.py
# ============================================================================ #
"""
MEDICAL KNOWLEDGE SERVICE Microservice
Version: 1.0.0
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting Medical Knowledge Service service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down Medical Knowledge Service service")
