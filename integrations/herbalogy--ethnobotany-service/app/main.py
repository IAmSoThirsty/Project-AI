...
# COMPLIANCE: Sovereign Substrate / Integrated Service: herbalogy--ethnobotany-service / main.py
# ============================================================================ #
"""
HERBALOGY & ETHNOBOTANY SERVICE Microservice
Version: 1.0.0
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting Herbalogy & Ethnobotany Service service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down Herbalogy & Ethnobotany Service service")
...
app = FastAPI(
    title="Herbalogy & Ethnobotany Service",
...
async def root():
    """Root endpoint"""
    return {
        "service": "Herbalogy & Ethnobotany Service",
        "version": "1.0.0",
        "status": "operational",
    }
