...
# COMPLIANCE: Sovereign Substrate / Integrated Service: cross-domain-synthesis-service / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Cross-Domain Synthesis Service - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Cross-Domain Synthesis Service`
