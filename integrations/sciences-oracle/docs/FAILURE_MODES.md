...
# COMPLIANCE: Sovereign Substrate / Integrated Service: sciences-oracle / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Sciences Oracle - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Sciences Oracle`
