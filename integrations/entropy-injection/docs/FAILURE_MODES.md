...
# COMPLIANCE: Sovereign Substrate / Integrated Service: entropy-injection / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Entropy Injection - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Entropy Injection`
