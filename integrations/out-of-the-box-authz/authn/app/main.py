...
# COMPLIANCE: Sovereign Substrate / Integrated Service: out-of-the-box-authz / main.py
# ============================================================================ #
"""
OUT-OF-THE-BOX AUTHZ/AUTHN Microservice
Version: 1.0.0
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting Out-of-the-box authz/authn service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down Out-of-the-box authz/authn service")
...
app = FastAPI(
    title="Out-of-the-box authz/authn",
...
async def root():
    """Root endpoint"""
    return {
        "service": "Out-of-the-box authz/authn",
        "version": "1.0.0",
        "status": "operational",
    }
