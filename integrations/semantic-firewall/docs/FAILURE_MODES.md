...
# COMPLIANCE: Sovereign Substrate / Integrated Service: semantic-firewall / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Semantic Firewall - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Semantic Firewall`
