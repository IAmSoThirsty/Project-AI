...
# COMPLIANCE: Sovereign Substrate / Integrated Service: dark-fiber-relay / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Dark-Fiber Relay - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Dark-Fiber Relay`
