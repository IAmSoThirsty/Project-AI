...
# COMPLIANCE: Sovereign Substrate / Integrated Service: temporal-anchor / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Temporal Anchor - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Temporal Anchor`
