...
# COMPLIANCE: Sovereign Substrate / Integrated Service: sase-signal-ingestion-service / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## SASE Signal Ingestion Service - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/SASE Signal Ingestion Service`
