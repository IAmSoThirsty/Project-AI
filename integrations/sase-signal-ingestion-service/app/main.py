...
# COMPLIANCE: Sovereign Substrate / Integrated Service: sase-signal-ingestion-service / main.py
# ============================================================================ #
"""
SASE SIGNAL INGESTION SERVICE Microservice
Version: 1.0.0
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SASE Signal Ingestion Service service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down SASE Signal Ingestion Service service")
...
app = FastAPI(
    title="SASE Signal Ingestion Service",
...
async def root():
    """Root endpoint"""
    return {
        "service": "SASE Signal Ingestion Service",
        "version": "1.0.0",
        "status": "operational",
    }
