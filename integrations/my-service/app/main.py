...
# COMPLIANCE: Sovereign Substrate / Integrated Service: my-service / main.py
# ============================================================================ #
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting my-service service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down my-service service")
