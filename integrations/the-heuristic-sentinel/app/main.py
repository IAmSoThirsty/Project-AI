...
# COMPLIANCE: Sovereign Substrate / Integrated Service: the-heuristic-sentinel / main.py
# ============================================================================ #
"""
THE HEURISTIC SENTINEL Microservice
Version: 1.0.0
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting The Heuristic Sentinel service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down The Heuristic Sentinel service")
...
async def root():
    """Root endpoint"""
    return {
        "service": "The Heuristic Sentinel",
        "version": "1.0.0",
        "status": "operational",
    }
