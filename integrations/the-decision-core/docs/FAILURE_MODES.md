...
# COMPLIANCE: Sovereign Substrate / Integrated Service: the-decision-core / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## The Decision Core - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/The Decision Core`
