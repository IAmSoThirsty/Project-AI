...
# COMPLIANCE: Sovereign Substrate / Integrated Service: logic-sanitizer / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Logic Sanitizer - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Logic Sanitizer`
