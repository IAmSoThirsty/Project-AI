...
# COMPLIANCE: Sovereign Substrate / Integrated Service: mnemonic-pruning / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## Mnemonic Pruning - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/Mnemonic Pruning`
