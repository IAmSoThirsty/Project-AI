...
# COMPLIANCE: Sovereign Substrate / Integrated Service: knowledge-decay-service / main.py
# ============================================================================ #
"""
KNOWLEDGE DECAY SERVICE Microservice
Version: 1.0.0
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting Knowledge Decay Service service v1.0.0")
...
logger.info("Service startup complete")
    ...
    # Shutdown
    logger.info("Shutting down Knowledge Decay Service service")
...
async def root():
    """Root endpoint"""
    return {
        "service": "Knowledge Decay Service",
        "version": "1.0.0",
        "status": "operational",
    }
