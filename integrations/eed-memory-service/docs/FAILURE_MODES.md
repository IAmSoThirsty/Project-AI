...
# COMPLIANCE: Sovereign Substrate / Integrated Service: eed-memory-service / FAILURE_MODES.md
# ============================================================================ #
# Failure Mode Matrix

## EED memory Service - Comprehensive Failure Analysis
...
2. Manual: `kubectl rollout undo deployment/EED memory Service`
