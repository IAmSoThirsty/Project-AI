...
# COMPLIANCE: Sovereign Substrate / security_tools_service.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / security_tools_service.py
...
class SecurityToolsService:
            ...
            with open(tool_path, "r", encoding="utf-8", errors="ignore") as f:
                ...
                for line in lines:
                    ...
                    if any(
                        ...
                        for marker in ["description:", "desc:", "purpose:"]
                    ):
    ...
    def execute_tool(
        ...
        try:
            from security.vault_access_control import AccessDeniedError, vault
