...
print("SECRET_KEY="[REDACTED]"FERNET_KEY=" + Fernet.generate_key().decode())
print("POSTGRES_PASSWORD="[REDACTED]"REDIS_PASSWORD="[REDACTED]"MCP_API_KEY="[REDACTED]"SELECT extname, extversion FROM pg_extension WHERE extname IN ('vector', 'pg_trgm');"
