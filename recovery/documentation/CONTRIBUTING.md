...
**Document Version:** 2.0 **Effective Date:** 2026-04-10 **Status:** Contributor Governance Framework
...
- **Read the [Active Governance Policy](docs/governance/policy/Active_Governance_Policy.md)** - All contributions must meet production-grade standards
- **Read the [Security Validation Claims Policy](docs/governance/policy/SECURITY_VALIDATION_POLICY.md)** - MANDATORY for all PRs making security or runtime enforcement claims
- **For documentation**: See [Documentation Contributing Guide](docs/DOCUMENTATION_STRUCTURE_GUIDE.md)
- Fork the repository
...
**[docs/governance/policy/Active_Governance_Policy.md](docs/governance/policy/Active_Governance_Policy.md)**
...
**[docs/governance/policy/SECURITY_VALIDATION_POLICY.md](docs/governance/policy/SECURITY_VALIDATION_POLICY.md)**
...
- [Documentation Contributing Guide](docs/DOCUMENTATION_STRUCTURE_GUIDE.md) - Where to place documentation
...
**Prerequisites:** Python 3.11 or higher (required for test compatibility)
...
- Docker builds currently fail due to deprecated Debian packages (under maintenance)
- Approximately 305 linting issues remain (mostly style/imports, non-critical)
- Test suite requires Python 3.11+ for full compatibility
...
For details, see [docs/governance/AUTOMATION.md](docs/governance/AUTOMATION.md).
...
1. Run the test suite: `pytest -v` (requires Python 3.11+)
...
**Note:** Test suite requires Python 3.11+ due to compatibility requirements. Verify your Python version with `python --version` before running tests.
...
**Last Updated:** 2026-04-10 **Next Review:** 2026-07-10
