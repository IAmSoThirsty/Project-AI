    ...
    for f in findings:
        ...
        result = {
            ...
            "locations": [
                {
                    "physicalLocation": {
                        "artifactLocation": {"uri": f.get("artifact_uri", "workspace://unknown")},
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Convert security findings to SARIF format")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        print("\n\nUsage Examples:")
        print("  python sarif_exporter.py --findings findings.json --output report.sarif")
