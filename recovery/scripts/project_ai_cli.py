...
sovereign runtime system - proving governance through execution, not documentation.
    ...
    verify_audit_parser.add_argument("audit_log", help="Path to immutable audit log file (JSONL)")

    # Verify bundle command
    verify_bundle_parser = subparsers.add_parser("verify-bundle", help="Verify compliance bundle")
