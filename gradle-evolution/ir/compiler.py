...
class CompilationError(Exception):
    ...
    def __init__(self, message: str, line_number: Optional[int] = None, source_file: Optional[str] = None):
...
class IntentCompiler:
    ...
    def compile(self, yaml_content: str, source_file: Optional[str] = None) -> IRGraph:
        """
    ...
    def _compile_step(self, step: Dict[str, Any], line_number: Optional[int] = None) -> IRNode:
    ...
    def _validate_policies(self, policies: List[str], line_number: Optional[int]) -> None:
