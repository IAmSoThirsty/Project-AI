...
3. Drag `index.html` to remote side
...
3. Drag `web/` folder onto page
4. Wait for deployment
5. Click **Domain settings**
6. Add custom domain: `thirstysprojects.com`
...
2. Click **New Project**
3. Import from Git: `IAmSoThirsty/Project-AI`
4. Root directory: `web/`
5. Click **Deploy**
6. Go to **Settings → Domains**
7. Add: `thirstysprojects.com`
...
2. Scroll to "Software Charter & Terms"
3. Verify:
...
2. Watch timer start automatically
3. Wait 2 minutes
4. Verify:
...
1. Check all 5 boxes
2. Click "Acknowledge Charter & Enable Downloads"
3. Verify:
...
2. Run: `deploy_to_thirstysprojects.bat`
