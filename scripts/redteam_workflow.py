...
# COMPLIANCE: Sovereign Substrate / redteam_workflow.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / redteam_workflow.py
...
async def run_red_team_attack(
    persona_id: str, target: dict[str, Any], snapshot_id: str
) -> dict[str, Any]:
    """
...
class RedTeamCampaignWorkflow:
    ...
    @workflow.run
    async def run(
        self, campaign_id: str, persona_ids: list[str], targets: list[dict[str, Any]]
    ) -> dict[str, Any]:
        """
...
async def execute_campaign(campaign_id: str, personas: list[str], targets: list[str]):
...
def main():
    ...
    execute_parser.add_argument(
        "--campaign-id", default=f"campaign-{uuid.uuid4().hex[:8]}", help="Campaign ID"
    )
    execute_parser.add_argument(
        "--personas", required=True, help="Comma-separated persona IDs"
    )
    execute_parser.add_argument(
        "--targets", required=True, help="Comma-separated target names"
    )
