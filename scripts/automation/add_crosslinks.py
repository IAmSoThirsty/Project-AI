...
def main():
    ...
    all_files = [
        f
        for f in all_files
        if "MISSION_COMPLETE" not in f.name and "README" not in f.name
    ]
    ...
    for file_path in all_files:
        ...
        patterns = [
            (
                ...
                "[[relationships/core-ai/01-FourLaws-Relationship-Map|FourLaws]].validate_action()",
            ),
            (
                "Pipeline System",
                "[[relationships/governance/01_GOVERNANCE_SYSTEMS_OVERVIEW|Pipeline System]]",
            ),
            (
                "audit trail",
                "[[relationships/governance/04_AUDIT_TRAIL_GENERATION|audit trail]]",
            ),
            (
                "Constitutional AI",
                "[[relationships/constitutional/01_constitutional_systems_overview|Constitutional AI]]",
            ),
        ]
