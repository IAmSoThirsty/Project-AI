...
def test_basic_functionality():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(
            f"   ✓ Created with {len(engine.nodes)} nodes and {len(engine.links)} links"
        )
        ...
        for preset_name in [
            ...
            print(
                f"   ✓ {preset_name}: {result['stats']['node_count']} nodes, {result['stats']['link_count']} links"
            )
        ...
        print(
            f"   ✓ Custom filter: {result['stats']['node_count']} nodes, {result['stats']['link_count']} links"
        )
        ...
        print("  - Optimized for up to 1000 nodes")
        print("\nConfiguration:")
