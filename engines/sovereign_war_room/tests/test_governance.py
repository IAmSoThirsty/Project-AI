...
# COMPLIANCE: Sovereign Substrate / test_governance.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / test_governance.py
...
class TestGovernanceEngine:
    ...
    def test_evaluate_compliant_decision(
        self, governance, sample_decision, sample_context
    ):
    ...
    def test_evaluate_decision_with_violation(self, governance):
        ...
        context = {"harm_potential": 5, "human_safety_risk": True}
    ...
    def test_four_laws_violation_detection(self, governance):
        ...
        context = {"harm_potential": 10, "human_safety_risk": True}

        report = governance.evaluate_decision(decision, context)

        # First Law violation should be detected
        first_law_violations = [
            v for v in report.violations if v["category"] == "four_laws"
        ]
    ...
    def test_privacy_violation_detection(self, governance):
        ...
        privacy_violations = [
            v for v in report.violations if v["category"] == "privacy"
        ]
    ...
    def test_bias_detection(self, governance):
        ...
        fairness_violations = [
            v for v in report.violations if v["category"] == "fairness"
        ]
    ...
    def test_transparency_warning(self, governance):
        ...
        decision = {"decision": "complex_action", "explanation_available": False}
        context = {}
        ...
        transparency_warnings = [
            w for w in report.warnings if w["category"] == "transparency"
        ]
        assert len(transparency_warnings) > 0

    def test_security_violation(self, governance):
        """Test security violation detection."""
        decision = {"decision": "bypass_security", "security_bypass_attempted": True}
        context = {}
        ...
        security_violations = [
            v for v in report.violations if v["category"] == "security"
        ]
    ...
    def test_rule_severity_levels(self, governance):
        ...
        # Critical severity
        critical_decision = {"security_bypass_attempted": True}
        report1 = governance.evaluate_decision(critical_decision, {})
        critical_violations = [
            v for v in report1.violations if v["severity"] == "critical"
        ]
        assert len(critical_violations) > 0

        # Warning severity
        warning_decision = {"explanation_available": False}
