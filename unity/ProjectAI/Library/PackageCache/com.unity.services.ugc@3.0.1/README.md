# How to install UGC Service into your Unity project
...
`com.unity.services.ugc` and select package.json > open
...
async void MakeAPICall()
{
    ...
    var response = await UGCInternalApiService.FakeClient.FakeApiGetAsync(r);
}
```
