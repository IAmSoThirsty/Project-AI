...
class ProjectAIAgent:
    ...
    def __init__(self, workspace_path: str = "."):
        ...
        self.ethical_review_patterns = [
            ...
            "user_data", "encryption", "password", "triumvirate"
        ]
        self.security_critical_patterns = [
            "password", "api_key", "secret", "token", "credential",
            "encryption", "decrypt", "hash", "salt"
        ]
        self.temporal_patterns = [
            "@workflow.defn", "@activity.defn", "temporalio",
    ...
    def analyze_task(self, task_description: str, affected_files: List[str]) -> Dict[str, Any]:
    ...
    async def request_triumvirate_review(self, 
                                       action: str, 
                                       description: str, 
    ...
    def validate_four_laws(self, action: str, context: Dict[str, Any]) -> tuple[bool, str]:
    ...
    def generate_recommendations(self, task_description: str, affected_files: List[str]) -> List[str]:
    ...
    def get_test_requirements(self, affected_files: List[str]) -> List[str]:
        ...
        has_temporal_changes = any("temporal/" in f or "src/app/temporal/" in f for f in affected_files)
...
def analyze_task_hook(task_description: str, affected_files: List[str]) -> Dict[str, Any]:
    """Hook for Antigravity to analyze tasks."""
    return agent.analyze_task(task_description, affected_files)


def get_recommendations_hook(task_description: str, affected_files: List[str]) -> List[str]:
...
async def request_review_hook(action: str, description: str, affected_files: List[str]) -> Dict[str, Any]:
