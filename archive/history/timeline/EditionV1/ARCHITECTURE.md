...
- Infrastructure-Only: The architecture components Thirsty-Lang, Shadow Thirst, TARL OS, SOVEREIGN_RUNTIME, PSIA Waterfall, Iron Path, Liara failover, and the Ambassador surface are fundamental production infrastructure; they are not optional features. All Edition V1 production guarantees rely on these systems being integrated and operational.
