...
class ProposalRepository:
    ...
    async def list(self, offset: int = 0, limit: int = 20) -> Tuple[List[MutationProposal], int]:
    ...
    async def update(self, proposal_id: UUID, updates: Dict[str, Any]) -> MutationProposal:
