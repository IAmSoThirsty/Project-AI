...
@router.get("/incidents", response_model=PaginatedIncidents, status_code=status.HTTP_200_OK)
...
@router.post("/incidents", response_model=SecurityIncident, status_code=status.HTTP_201_CREATED)
