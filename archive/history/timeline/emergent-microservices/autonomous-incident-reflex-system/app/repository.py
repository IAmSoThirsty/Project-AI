...
class IncidentRepository:
    ...
    async def list(self, offset: int = 0, limit: int = 20) -> Tuple[List[SecurityIncident], int]:
    ...
    async def update(self, incident_id: UUID, updates: Dict[str, Any]) -> SecurityIncident:
