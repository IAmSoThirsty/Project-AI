...
# COMPLIANCE: Sovereign Substrate / test_adversarial_e2e.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / test_adversarial_e2e.py
...
class InputValidator:
    ...
    def sanitize_html(value: str) -> str:
        """Sanitize HTML to prevent XSS. Also escapes '=' for strict tests."""
...
class AuthenticationSystem:
    ...
    def authenticate(self, username: str, password: str) -> AuthToken | None:
        ...
        # Constant time comparison (simulated with sleep for test reliability)
        time.sleep(0.01) 
