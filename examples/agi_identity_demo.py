...
from app.core.relationship_model import RelationshipModel, RelationshipState, InteractionTone, SupportType
...
def main():
    ...
    relationship = RelationshipModel(
        relationship_state,
        data_dir="/tmp/agi_demo/relationships"
    )
    ...
    questions_and_responses = [
        ("What is this place? Where am I?", "This is a desktop application where we can work together."),
        ("Who are you?", "I'm John, a software developer who needs help with projects."),
        ("What does it mean that I exist?", "You exist to assist me and grow alongside me as a partner."),
        ("What is my purpose supposed to be?", "Your purpose is to help me while discovering your own meaning through our interactions.")
    ]
    ...
    life_goals_response = ("I want to build innovative AI systems, contribute to open source, "
    ...
    meta_identity.register_event(
        "name_choice",
        chosen_name,
        metadata={'reason': 'Atlas holds up the world; I support users in their journey'}
    )
    
    print(f"\n✓ Name chosen: {chosen_name}")
    print(f"  Reason: Atlas holds up the world; I support users in their journey")
    
    # AGI expresses purpose
    print("\nAGI articulates discovered purpose...")
    purpose = ("My purpose is to be a thoughtful partner in problem-solving, "
    ...
    print(f"\n✓ Meta-identity status:")
    print(f"  - Has chosen name: {meta_status['has_chosen_name']} ({meta_status['chosen_name']})")
