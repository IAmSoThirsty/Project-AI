...
4. Begin log preservation
5. Initiate appropriate response based on severity
...
2. Re‑enable endpoint registration
3. Validate secure signaling (H.235.3/4)
4. Validate SRTP media (H.235.6)
5. Validate RAS authentication (H.235.2)
6. Perform controlled test calls
7. Monitor for recurrence (72 hours)
...
3. **Recovery Priority Order**
   ...
   2. Renew GK certificates
   3. Renew GW certificates
   4. Renew EP certificates
   5. Validate full trust chain
