...
from emp_defense.modules.sectorized_state import SectorizedWorldState
...
class FailureStatesEngine:
    ...
    def _register_failure_thresholds(self) -> None:
        ...
        self.thresholds.append(
            FailureThreshold(
                ...
                description="Water <20% for 60+ days → death rate ×3",  # noqa: RUF001
    ...
    def _apply_water_death_spiral(self, state: SectorizedWorldState) -> None:
        """Water death spiral: Death rate ×3."""  # noqa: RUF002
        ...
        state.major_events.append("IRREVERSIBLE: Water scarcity death rate permanently ×3")  # noqa: RUF001
    ...
    def get_failure_status(self, state: SectorizedWorldState) -> dict:
        ...
        return {
            ...
            "cascading_failures": len(
                [f for f in state.failure_states_triggered if f not in self.triggered_failures]
            ),
        }
