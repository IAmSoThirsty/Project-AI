...
from django_state.kernel import CollapseScheduler, IrreversibilityLaws, RealityClock
...
from django_state.schemas import EngineConfig, Event, StateVector
...
class DjangoStateEngine:
    ...
    def __init__(self, config: EngineConfig | None = None):
        ...
        # Kernel components
        self.clock: RealityClock | None = None
        self.laws: IrreversibilityLaws | None = None
        self.collapse_scheduler: CollapseScheduler | None = None

        # Modules
        self.human_forces: HumanForcesModule | None = None
        self.institutional_pressure: InstitutionalPressureModule | None = None
        self.perception_warfare: PerceptionWarfareModule | None = None
        self.red_team: RedTeamModule | None = None
        self.metrics: MetricsModule | None = None
    ...
    def _apply_event(self, event: Event) -> dict[str, Any]:
        ...
        """
        from django_state.schemas.event_schema import (
            BetrayalEvent,
            CooperationEvent,
            EventType,
    ...
    def export_artifacts(self) -> dict[str, Any]:
        ...
        artifacts = {
            ...
            "outcome_report": (
                self.outcomes.generate_outcome_report(self.state) if self.state else None
            ),
            "module_summaries": {
                "human_forces": self.human_forces.get_summary(),
                "institutional_pressure": self.institutional_pressure.get_summary(),
