...
from django_state.schemas.config_schema import IrreversibilityConfig, OutcomeThresholds
from django_state.schemas.state_schema import StateVector
...
class TestRedTeamModule:
    ...
    def test_black_vault_fingerprinting(self):
        ...
        laws = IrreversibilityLaws(IrreversibilityConfig())
        module = RedTeamModule(laws, black_vault_enabled=True)
        from django_state.schemas.event_schema import BetrayalEvent
...
class TestTimelineModule:
    ...
    def test_event_recording(self):
        ...
        module = TimelineModule()
        from django_state.schemas.event_schema import Event, EventType
    ...
    def test_chain_integrity(self):
        ...
        is_valid, _error = module.verify_chain_integrity()
        assert is_valid
