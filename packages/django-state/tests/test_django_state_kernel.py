...
import pytest
from django_state.kernel.collapse_scheduler import CollapseScheduler
from django_state.kernel.irreversibility_laws import IrreversibilityLaws
from django_state.kernel.reality_clock import RealityClock
from django_state.schemas.config_schema import IrreversibilityConfig
...
class TestStateDimension:
    ...
    def test_dimension_update(self):
        ...
        # Use approx for FP comparison: 0.7 - 0.5 in IEEE 754 is
        # 0.19999999999999996, not exactly 0.2.
...
class TestRealityClock:
    ...
    def test_causal_chain_verification(self):
        ...
        is_valid, _error = clock.verify_causal_consistency()
        assert is_valid
