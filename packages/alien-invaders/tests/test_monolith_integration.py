...
from alien_invaders.modules.world_state import Country, GlobalState
...
class TestIntegrationPointB:
    ...
    def test_causal_clock_is_shared_reference(self):
        ...
        from alien_invaders import AlienInvadersEngine
...
class TestIntegrationPointC:
    ...
    def test_registry_projection_mode_enforcement(self):
        ...
        from alien_invaders._simulation_contract import SimulationRegistry
