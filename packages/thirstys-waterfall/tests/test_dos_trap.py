...
class TestNoHardcodedSecrets(unittest.TestCase):
    ...
    def test_no_hardcoded_secrets_in_dos_trap_demo(self):
        ...
        for pattern in forbidden_patterns:
            ...
            self.assertNotIn(pattern_str, content, f"Found hardcoded secret pattern: {pattern_str}")
    ...
    def test_security_documentation_exists(self):
        ...
        self.assertTrue(os.path.exists(security_md), "SECURITY.md documentation must exist")
