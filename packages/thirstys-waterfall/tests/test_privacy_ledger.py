...
class TestPrivacyLedger(unittest.TestCase):
    ...
    def test_ledger_merkle_tree_integration(self):
        ...
        for i, entry in enumerate(entries):
            ...
            # Verify proof
            is_valid = ledger.merkle_tree.verify_proof(entry.hash, fresh_proof, root, merkle_idx)
    ...
    def test_ledger_export_audit_log(self):
        ...
        ledger.append(event_type=EventType.DATA_ACCESS, user_id="user2", action="Data access")
...
class TestPrivacyLedgerIntegration(unittest.TestCase):
    ...
    def test_complete_audit_workflow(self):
        ...
        count = ledger.export_audit_log(export_path, user_id="john.doe", decrypt_sensitive=True)
