...
def get_demo_credentials() -> dict:
    ...
    if master_encryption_key:
        ...
        print("  ℹ️  Generated random master_encryption_key (not from env)")  # noqa: RUF001
    ...
    if master_signing_key:
        ...
        print("  ℹ️  Generated random master_signing_key (not from env)")  # noqa: RUF001
    ...
    if root_key:
        ...
        print("  ℹ️  Generated random root_key (not from env)")  # noqa: RUF001
...
def demo_hardware_integration():
    ...
    dos_trap = DOSTrapMode(hardware_root_of_trust=hw_trust, kill_switch=kill_switch)
    dos_trap.initialize()
...
def demo_disk_sanitization():
    ...
    dos_trap.disk_sanitizer.sanitize_file(test_path, SanitizationMode.THREE_PASS)
