...
class ContentBlocker:
    ...
    def _contains_popup_code(self, content: str) -> bool:
        ...
        return any(re.search(pattern, content, re.IGNORECASE) for pattern in popup_patterns)
    ...
    def _contains_redirect_code(self, content: str) -> bool:
        ...
        return any(re.search(pattern, content, re.IGNORECASE) for pattern in redirect_patterns)
    ...
    def _is_ad(self, url: str) -> bool:
        ...
        return any(domain in url for domain in self._ad_domains)
