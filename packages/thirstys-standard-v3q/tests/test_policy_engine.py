...
def test_denied_action_never_reaches_executor(manifest, owner_keys) -> None:
    ...
    result = engine.enforce(
        task(), {"action_id": "a1", "type": "inspect", "class": "read_only"}, None, None, executor
    )
