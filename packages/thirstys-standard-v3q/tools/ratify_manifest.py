...
from thirstys_standard_runtime.ratification import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Ratify an exact manifest release with the owner's Ed25519 key."
    )
    ...
    try:
        ...
        record = create_ratification_record(
            manifest_temp, ratified, private_key, args.effective_date
        )
        with tempfile.NamedTemporaryFile(
            mode="w",
            encoding="utf-8",
