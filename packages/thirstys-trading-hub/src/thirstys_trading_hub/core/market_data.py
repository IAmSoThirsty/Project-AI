...
class MarketDataProvider:
    ...
    def _generate_mock_ohlcv(self, symbol: str, timeframe: Timeframe, limit: int) -> list[OHLCV]:
    ...
    def get_data(self, symbol: str, timeframe: Timeframe | str, limit: int = 100) -> list[OHLCV]:
        ...
        if self.mode == MarketMode.PAPER:
            if cache_key in self._cache:
                ...
                if cache_age < 300:
                    ...
                    return [OHLCV(**candle) for candle in cached_data.get("candles", [])]
