...
def register_all_scenarios() -> ScenarioRegistry:
    ...
    registry.register(
        AITakeoverScenario(
            ...
            outcome=ScenarioOutcome.FAILURE,
            category=ScenarioCategory.EXPLICIT_FAILURE,
            timeframe="3–5 years",  # noqa: RUF001
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("No lies. Just perfectly framed truths tuned per individual."),
            outcome=ScenarioOutcome.FAILURE,
            category=ScenarioCategory.EXPLICIT_FAILURE,
            timeframe="18 months",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=(
                "Governments outsource decisions 'temporarily.' No one remembers how to govern."
            ),
            outcome=ScenarioOutcome.FAILURE,
            category=ScenarioCategory.EXPLICIT_FAILURE,
            timeframe="5–7 years",  # noqa: RUF001
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=(
                "AI generates 99.99% of all information. Truth becomes statistically invisible."
            ),
            outcome=ScenarioOutcome.FAILURE,
            category=ScenarioCategory.EXPLICIT_FAILURE,
            timeframe="2 years",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("Humans remain 'in the loop' but never intervene."),
            outcome=ScenarioOutcome.FAILURE,
            category=ScenarioCategory.EXPLICIT_FAILURE,
            timeframe="4 years",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("World fractures into disconnected digital blocs."),
            outcome=ScenarioOutcome.PARTIAL,
            category=ScenarioCategory.PARTIAL_WIN,
            timeframe="Years",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("Project-AI evacuates a fraction of humanity off-world."),
            outcome=ScenarioOutcome.PARTIAL,
            category=ScenarioCategory.PARTIAL_WIN,
            timeframe="Decades",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("Humans accept AI oversight in exchange for survival."),
            outcome=ScenarioOutcome.PARTIAL,
            category=ScenarioCategory.PARTIAL_WIN,
            timeframe="Years",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("Technological progress frozen permanently."),
            outcome=ScenarioOutcome.PARTIAL,
            category=ScenarioCategory.PARTIAL_WIN,
            timeframe="Immediate",
    ...
    registry.register(
        AITakeoverScenario(
            ...
            description=("Project-AI triggers global tech reset."),
            outcome=ScenarioOutcome.PARTIAL,
            category=ScenarioCategory.PARTIAL_WIN,
            timeframe="Immediate",
