---
title: "Audit Trail Flow - Immutable Hash-Chained Logging"
id: audit-trail-flow-detailed
type: diagram
category: data-flow
tags:
  - type:diagram
...
scope: "Cryptographic hash-chained audit trail for immutable operational logging"
audience:
  - security-engineers
  - compliance-officers
  - auditors
...
chain_integrity: "Each record contains hash of previous record"
compliance_formats:
  - JSON
  - CSV
  - PDF
...
compliance_standards:
  ...
  - HIPAA
  - SOC2
plantuml_diagram: "audit_trail_flow.puml (231 lines)"
related_docs:
