---
title: "User Request Flow - Complete Request Lifecycle"
id: user-request-flow-detailed
type: diagram
category: data-flow
tags:
  - type:diagram
...
scope: "Complete journey of user interaction from input through governance, execution, and response"
audience:
  - developers
  - architects
  - technical-leads
...
plantuml_diagram: "user_request_flow.puml (319 lines)"
related_docs:
  - "[[governance_decision_flow]]"
  - "[[memory_recording_flow]]"
  - "[[component/cognition_kernel]]"
keywords:
  - request-processing
  - api-gateway
  - intent-detection
...
3. **Compliance**: GDPR, HIPAA, SOC2 requirements
4. **Business Rules**: Domain-specific constraints
5. **Resource Limits**: CPU, memory, storage quotas
6. **Operational Constraints**: Maintenance windows, blackout periods
