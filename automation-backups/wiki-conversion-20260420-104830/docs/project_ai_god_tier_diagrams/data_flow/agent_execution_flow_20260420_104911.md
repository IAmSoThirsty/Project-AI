---
title: "Agent Execution Flow - Dynamic Agent Orchestration"
id: agent-execution-flow-detailed
type: diagram
category: data-flow
tags:
  - type:diagram
...
scope: "Sophisticated system for dynamic agent selection, orchestration, and monitoring"
audience:
  - developers
  - architects
  - technical-leads
...
agent_categories:
  - core_agents: "Intelligence, Learning, Memory, Command"
  - analysis_agents: "Data Analysis, Security Scan, Pattern Detection, Forecasting"
  - utility_agents: "Image Generation, Location, Emergency, File Management"
total_agents: 30+
plantuml_diagram: "agent_execution_flow.puml (223 lines)"
related_docs:
  - "[[user_request_flow]]"
  - "[[component/README]]"
keywords:
