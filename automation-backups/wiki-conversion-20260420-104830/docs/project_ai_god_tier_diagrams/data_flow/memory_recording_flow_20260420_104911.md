---
title: "Memory Recording Flow - Five-Channel Recording System"
id: memory-recording-flow-detailed
type: diagram
category: data-flow
tags:
  - type:diagram
...
scope: "Comprehensive five-channel recording system capturing complete operational context"
audience:
  - developers
  - architects
  - data-engineers
...
channels:
  - attempt: "User request, intent, context, timestamp, entities"
  - decision: "Governance decisions, approval/rejection, rationale"
  - result: "Execution output, status code, side effects, duration"
  - reflection: "Post-execution analysis, learning, improvements, insights"
  - error: "Exceptions, stack traces, recovery actions, root cause"
storage_backend: "PostgreSQL with JSONB columns, partitioned by timestamp"
plantuml_diagram: "memory_recording_flow.puml (174 lines)"
related_docs:
  - "[[user_request_flow]]"
  - "[[governance_decision_flow]]"
  - "[[component/README]]"
keywords:
  - memory-architecture
  - five-channel-system
