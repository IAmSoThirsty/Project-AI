...
# COMPLIANCE: Sovereign Substrate / thirsty_super_kernel.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / thirsty_super_kernel.py
...
from kernel.cxl_substrate import SubstrateManager, CXLMemoryPool
...
class ThirstySuperKernel:
    ...
    def __init__(self, config: SystemConfig | None = None):
        ...
        # Hardware Substrate (CXL / HierKNEM)
        self.substrate = SubstrateManager()
        self.substrate.memory_pools["POOL_0"] = CXLMemoryPool("POOL_0", 1024.0)
        logger.info("✅ CXL/HierKNEM Substrate initialized")
