    ...
    <Router>
      <div className="app">
        <Routes>
          ...
          <Route 
            path="/analysis" 
            element={isAuthenticated ? <DataAnalysis /> : <Navigate to="/login" />} 
          />
          <Route 
            path="/learning" 
            element={isAuthenticated ? <LearningPaths /> : <Navigate to="/login" />} 
          />
          <Route 
            path="/security" 
            element={isAuthenticated ? <SecurityResources /> : <Navigate to="/login" />} 
          />
