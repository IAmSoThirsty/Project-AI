...
class MultiPartyApproval:
    ...
    def request_approval(self, action: str, requestor: str,
                        required_approvers: Set[Role]) -> ApprovalRequest:
...
class RBACEngine:
    ...
    def require_approval(self, action: str, user_id: str,
                        required_roles: Set[Role]) -> ApprovalRequest:
        """Require multi-party approval"""
        return self.multi_party.request_approval(action, user_id, required_roles)


__all__ = ['Role', 'Permission', 'Permissions', 'RolePermissions', 
           'ApprovalRequest', 'MultiPartyApproval', 'RBACEngine']
