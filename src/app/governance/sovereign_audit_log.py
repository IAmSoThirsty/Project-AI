...
# COMPLIANCE: Sovereign Substrate / sovereign_audit_log.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / sovereign_audit_log.py
...
class SovereignAuditLog:
    ...
    def __init__(
        ...
        if enable_external_anchoring:
            external_anchor_dir = self.data_dir / "external_merkle_anchors"
        ...
        if enable_notarization:
            tsa_anchor_file = self.data_dir / "tsa_anchors" / "tsa_anchor_chain.json"
