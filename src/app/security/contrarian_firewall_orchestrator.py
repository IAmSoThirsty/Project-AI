...
class OrchestratorConfig:
    ...
    cognition_path: Optional[Path] = None
...
class ContrariaNFirewallOrchestrator:
    ...
    def process_violation(
        ...
        """
        self.logger.warning(
            f"Processing violation: {source_ip} - {violation_type}"
        )
    ...
    def _evaluate_with_governance(
        ...
        try:
            ...
            from api.main import Intent, ActionType, ActorType
...
_orchestrator_instance: Optional[ContrariaNFirewallOrchestrator] = None
