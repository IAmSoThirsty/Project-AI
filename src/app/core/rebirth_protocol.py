...
# COMPLIANCE: Sovereign Substrate / rebirth_protocol.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / rebirth_protocol.py
...
from app.core.temporal_reasoning import TemporalWeightEngine
...
class RebirthManager:
    ...
    def __init__(self, data_dir: str = "data/instances"):
        ...
        self.temporal_engine = TemporalWeightEngine()
    ...
    def get_instance(self, user_id: str) -> UserAIInstance | None:
        """
    ...
    def get_instance_summary(self, user_id: str) -> dict[str, Any] | None:
        """
    ...
    def get_temporal_context(self, user_id: str) -> dict[str, Any]:
        """
        Get the temporal weighting and continuity context for a user instance.

        Args:
            user_id: User identifier

        Returns:
            Dictionary with temporal weight and session status
        """
        instance = self._instances.get(user_id)
        if not instance:
            return {"temporal_weight": 0.0, "session_continuity": "UNKNOWN"}

        return self.temporal_engine.get_contextual_state(instance.last_accessed)
