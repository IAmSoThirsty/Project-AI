...
class SLAMetrics:
    ...
    last_check: datetime = field(default_factory=lambda: datetime.now(datetime.UTC) if hasattr(datetime, 'UTC') else datetime.utcnow())
    ...
    def meets_sla(self) -> bool:
        ...
        if p_latency > self.config.target_latency_ms:
            return False
...
class MetricsCollector:
    ...
    def create_counter(self, name: str, description: str, labels: Optional[List[str]] = None) -> Optional[Any]:
    ...
    def create_gauge(self, name: str, description: str, labels: Optional[List[str]] = None) -> Optional[Any]:
    ...
    def create_summary(self, name: str, description: str, labels: Optional[List[str]] = None) -> Optional[Any]:
...
class SLATracker:
    ...
    def get_all_sla_status(self) -> Dict[str, Dict[str, Any]]:
        ...
        with self._lock:
            return {
                name: self.check_sla(name)[1]
                for name in self._slas.keys()
            }
