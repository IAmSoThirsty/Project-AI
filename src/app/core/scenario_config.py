...
REGIONAL_GROUPS = {
    ...
    "europe": ["DEU", "GBR", "FRA", "ITA", "ESP", "NLD", "POL", "SWE", "BEL", "AUT", "CHE", "NOR", "DNK"],
...
ECONOMIC_BLOCS = {
    ...
    "g20": ["USA", "CHN", "JPN", "DEU", "GBR", "FRA", "IND", "ITA", "BRA", "CAN", 
    ...
    "emerging": ["CHN", "IND", "BRA", "RUS", "ZAF", "MEX", "IDN", "TUR", "SAU", 
                 "ARG", "THA", "MYS", "PHL", "EGY", "PAK", "BGD", "VNM", "NGA"],
}

# Development status classifications
DEVELOPMENT_CATEGORIES = {
    "developed": ["USA", "CAN", "GBR", "DEU", "FRA", "ITA", "ESP", "JPN", "KOR", 
                  "AUS", "NLD", "CHE", "SWE", "NOR", "DNK", "BEL", "AUT", "SGP", 
                  "NZL", "ISR", "HKG", "TWN"],
    "emerging": ["CHN", "IND", "BRA", "RUS", "ZAF", "MEX", "IDN", "TUR", "SAU", 
                 "ARG", "THA", "MYS", "PHL", "EGY", "PAK", "BGD", "VNM", "NGA", 
                 "COL", "PER", "MAR", "KEN"],
    "developing": ["ETH", "GHA", "UZB", "KAZ", "DZA", "VEN", "UKR", "ARE", "QAT", 
                   "KWT", "IRN", "CHL", "POL"],
}

# Population tiers for weighted analysis
POPULATION_TIERS = {
    "mega": ["CHN", "IND", "USA", "IDN", "PAK", "BRA", "NGA", "BGD", "RUS", "MEX"],  # 100M+
    "large": ["JPN", "ETH", "PHL", "EGY", "VNM", "TUR", "IRN", "DEU", "THA", "GBR", 
              "FRA", "ITA", "ZAF", "KOR", "ESP"],  # 50-100M
    "medium": ["COL", "ARG", "DZA", "UKR", "CAN", "MAR", "SAU", "UZB", "PER", "MYS", 
               "VEN", "GHA", "AUS", "KAZ"],  # 20-50M
    "small": ["NLD", "CHL", "KEN", "POL", "TWN", "BEL", "SWE", "CHE", "AUT", "ARE", 
              "ISR", "NOR", "SGP", "DNK", "HKG", "NZL", "QAT", "KWT"],  # <20M
}
...
DEFAULT_DEMO_CONFIG = {
    ...
    "sample_countries": ["USA", "CHN", "GBR", "DEU", "FRA", "IND", "BRA", "RUS"],  # Original 8
}
