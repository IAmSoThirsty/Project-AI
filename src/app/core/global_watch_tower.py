...
class GlobalWatchTower:
    """Singleton wrapper for the Border Patrol Watch Tower system.

    Provides global access to border patrol services including:
    ...
    def initialize(
        ...
        with cls._lock:
            ...
            logger.info(
                "GlobalWatchTower initialized: %d admins, %d towers, %d gates",
