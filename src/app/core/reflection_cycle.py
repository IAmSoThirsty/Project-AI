...
class ReflectionCycle:
    ...
    def __init__(self, data_dir: str = "data/reflection"):
        ...
        self.last_daily_reflection: str | None = None
        self.last_weekly_reflection: str | None = None
    ...
    def _load_history(self):
        ...
        if os.path.exists(history_file):
            try:
                ...
                logger.info(
                    f"Loaded reflection history: {self.total_reflections} cycles"
                )
    ...
    def perform_daily_reflection(
        ...
        logger.info(
            f"Daily reflection complete: {len(report.insights)} insights discovered"
        )
        return report
    ...
    def perform_weekly_reflection(
        self, memory_engine: Any, perspective_engine: Any, identity: Any = None
    ) -> ReflectionReport:
        """
        ...
        logger.info(
            f"Weekly reflection complete: {len(report.insights)} insights, "
