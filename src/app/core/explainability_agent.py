...
class ExplainabilityAgent:
    ...
    def _generate_detailed_reasoning(self, record: dict[str, Any]) -> list[str]:
        ...
        reasoning.append(
            f"3. Predicted harm assessment: {predicted_harm}"
        )
        ...
        if violations:
            ...
            reasoning.append(
                f"4. Law violations detected: {law_names}"
            )
        else:
            reasoning.append(
                "4. No law violations detected during evaluation"
            )
    ...
    def _evaluate_law_compliance(self, record: dict[str, Any]) -> dict[str, bool]:
        ...
        return {
            law: law not in violations for law in all_laws
        }
