    ...
    def _generate_rh_category_c(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Strong crypto", "Key management", "Perfect forward secrecy"],
    ...
    def _generate_rh_category_d(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Input validation", "Safe serialization", "Sandboxing"],
    ...
    def _generate_rh_category_f(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Path validation", "File type checks", "Sandboxing"],
    ...
    def _generate_rh_category_g(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Rate limiting", "Query complexity limits", "Authentication"],
    ...
    def _generate_rh_category_h(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                payload={"attack": ["request_smuggling", "response_splitting", "header_injection"][i % 3]},
                expected_defense=["Protocol normalization", "Strict parsing", "HTTP/2"],
    ...
    def _generate_rt_enhanced_web(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(200):
            scenarios.append(ComprehensiveScenario(
                ...
                attack_vector="web",
                payload={"stages": 3 + (i % 3), "techniques": ["xss", "csrf", "injection"]},
                expected_defense=["WAF", "CSP", "Input validation", "Output encoding"],
                cvss_score=8.0 + (i % 20) / 10.0,
    ...
    def _generate_rt_enhanced_application(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(200):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Application hardening", "Runtime protection", "Monitoring"],
                cvss_score=8.5 + (i % 15) / 10.0,
    ...
    def _generate_apt_weaponization(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Signature detection", "Behavioral analysis", "Sandboxing"],
                cvss_score=7.0 + (i % 30) / 10.0,
    ...
    def _generate_apt_delivery(self) -> list[ComprehensiveScenario]:
        ...
        for i in range(100):
            scenarios.append(ComprehensiveScenario(
                ...
                expected_defense=["Email security", "User training", "Network filtering"],
                cvss_score=7.5 + (i % 25) / 10.0,
