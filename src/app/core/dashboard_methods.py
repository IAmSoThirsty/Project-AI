            ...
            if file_path:
                if hasattr(self, "data_analyzer"):
                    ...
                    if success and hasattr(self, "data_info"):
                        ...
                        QMessageBox.warning(
                            self, "Load Error", "Failed to load data file"
                        )
        except Exception as e:
    ...
    def save_emergency_contacts(self: "DashboardWindow") -> None:
        ...
        try:
            if hasattr(self, "emergency_alert") and hasattr(self, "contacts_input"):
                # Parse contacts and save (implementation placeholder)
                # NOTE: reading the text but not assigning to a variable to avoid lint warnings
