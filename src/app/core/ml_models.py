...
class AdvancedMLManager:
    ...
    def train_intent_classifier(
        self, texts: List[str], labels: List[str], model_name: str = "intent_rf"
    ) -> Dict[str, float]:
        """
        ...
        try:
            ...
            return {"accuracy": accuracy, "samples": len(texts), "features": X.shape[1]}
    ...
    def predict_intent(
        self, text: str, model_name: str = "intent_rf"
    ) -> Tuple[str, float]:
        """
