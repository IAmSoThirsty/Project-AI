...
from .tscg_codec import TSCGCodec, TSCGSemanticDictionary, SymbolType
from .state_register import StateRegister, HumanGapCalculator, SessionMetadata
from .octoreflex import OctoReflex, ViolationType, EnforcementLevel, get_octoreflex
from .directness import DirectnessDoctrine, TruthPriority, DirectnessLevel
from .constitutional_model import (
    ConstitutionalModel, AGICharterValidator,
    ConstitutionalRequest, ConstitutionalResponse
)
...
class ConstitutionalValidator:
    ...
    def _validate_integration(self):
        ...
        try:
            ...
            text = "Test statement"
            revised = directness.enforce_truth_first(text)
...
def main():
    ...
    report = validator.generate_report(
        output_file="t:\\Project-AI-main\\constitutional_validation_report.txt"
    )
    print(report)
