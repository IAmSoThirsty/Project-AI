...
from .exceptions import ConfigValidationError, ConfigMissingError
...
class ConfigValidator:
    ...
    def create_example_schema(self, schema_name: str, output_path: Optional[Path] = None) -> Dict[str, Any]:
        """
    ...
    **kwargs
    ...
    if config_type == "subsystem":
        return validator.validate_subsystem_config(
            subsystem_id=kwargs.get("subsystem_id", "unknown"),
            config=config
        )
