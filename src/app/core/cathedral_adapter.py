...
from .observability import get_observability_system, ObservabilitySystem
from .config_validator import ConfigValidator
from .secrets_manager import get_secrets_manager, SecretsManager
from .security_validator import get_security_validator, SecurityValidator
from .exceptions import ProjectAIError, SubsystemError
...
class CathedralInfrastructureAdapter:
    ...
    def _default_health_check(self, instance: Any) -> Optional[Callable[[], bool]]:
...
_cathedral_adapter: Optional[CathedralInfrastructureAdapter] = None
