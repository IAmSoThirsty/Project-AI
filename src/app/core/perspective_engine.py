...
class DriftMetrics:
    ...
    last_major_shift: Optional[str] = None  # Timestamp of last big change
...
class PerspectiveEngine:
    ...
    def __init__(self, data_dir: str = "data/perspective"):
        ...
        self.genesis_perspective: Optional[PerspectiveState] = None  # Original baseline
    ...
    def _load_state(self):
        ...
        if os.path.exists(state_file):
            try:
                ...
                logger.info(f"Loaded perspective state: {self.interaction_count} interactions")
    ...
    def suggest_work_profile(self, context: str) -> Optional[str]:
        """
        ...
        for profile_name, profile in self.work_profiles.items():
            matches = sum(
                1 for keyword in profile.trigger_keywords
