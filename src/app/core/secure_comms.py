...
# COMPLIANCE: Sovereign Substrate / secure_comms.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / secure_comms.py
...
class SecureCommunicationsKernel(
    ...
    def _deserialize_message(self, msg_bytes: bytes) -> SecureMessage | None:
    ...
    def _select_best_transport(self, route: RouteEntry) -> TransportEndpoint | None:
    ...
    def _get_peer_public_key(self, peer_id: str) -> bytes | None:
