...
class TSCGCodec:
    ...
    def __init__(self, dictionary: TSCGSemanticDictionary | None = None):
        self.dictionary = dictionary or TSCGSemanticDictionary()
        self.version = "2.1"
        self.encoding_history: list[str] = []

    def encode_state(
        self, state_data: dict[str, Any], temporal_context: dict[str, Any] | None = None
    ) -> str:
        """
...
def encode_state(state: dict[str, Any], temporal: dict | None = None) -> str:
