...
the Thirsty-lang implementation. Commands are hardcoded and paths are validated.
"""
import logging
...
class ThirstyLangValidator:
    ...
    def _test_basic_language(self) -> dict[str, Any]:
        ...
        try:
            # Run the language's built-in tests - npm is a trusted dev tool, cwd is validated
    ...
    def _test_security_features(self) -> dict[str, Any]:
        ...
        try:
            # Run security tests - node is a trusted dev tool, cwd is validated
            result = subprocess.run(  # nosec B603, B607
