...
# COMPLIANCE: Sovereign Substrate / planner_agent.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / planner_agent.py

#
# COMPLIANCE: Sovereign Substrate / Planner / Scheduler Agent



# COMPLIANCE: Sovereign Substrate / Project-AI Council Contract
...
from app.core.council import CouncilRole
...
class PlannerAgent(KernelRoutedAgent):
    ...
    def get_role(self) -> CouncilRole:
        """Requirement for CouncilMemberInterface."""
        return CouncilRole.PLANNER

    def execute_action(self, action_name: str, params: Dict[str, Any]) -> Any:
        """Requirement for CouncilMemberInterface."""
        if action_name == "schedule":
            return self.schedule(params.get("task"))
        elif action_name == "run_next":
