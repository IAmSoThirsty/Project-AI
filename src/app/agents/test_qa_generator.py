...
Security Note: This agent uses subprocess to run pytest, a trusted testing
framework. Commands are hardcoded and do not accept external input.
"""
from __future__ import annotations

import logging
import os
import subprocess  # nosec B404 - subprocess usage for trusted test tool only
import time
...
class TestQAGenerator:
    ...
    def run_tests(self, tests_dir: str | None = None) -> dict[str, Any]:
        ...
        Security: Runs pytest with hardcoded arguments on a validated test directory.
        """
        ...
        try:
            # pytest is a trusted dev tool, path validated above
