...
class TronFacePage(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        for status_name in ["Neural Sync", "Data Stream", "Memory Cache", "Security"]:
...
class TronFaceCanvas(QFrame):
    ...
    def _draw_wireframe_face(self, painter):
        ...
        painter.drawEllipse(center_x - 20 - eye_radius, center_y - 15 - eye_radius,
        ...
        for i in range(mouth_width):
            ...
            mouth_points.append((center_x + x_offset, center_y + 30 + y_offset))
