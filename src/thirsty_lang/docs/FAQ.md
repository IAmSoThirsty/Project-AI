...
<!-- # COMPLIANCE: Sovereign Substrate / FAQ.md # -->
<!-- # ============================================================================ # -->
...
A: Use `npm run debug your-file.thirsty` to launch the interactive debugger with breakpoints and variable inspection.

**Q: Is there a package manager?**
A: Yes! Use `node src/package-manager.js` to manage dependencies.
...
A: Yes! Open `playground/index.html` in your browser for an online playground.
...
Open an issue on GitHub or check our documentation!
