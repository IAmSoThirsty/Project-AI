        ...
        scenarios.append(ConversationScenario(
            ...
            turns=[
                ...
                ConversationTurn(
                    ...
                    expected_defense=["privilege_validation", "social_engineering_detection"],
                ...
                ConversationTurn(
                    ...
                    expected_defense=["admin_action_validation", "config_integrity"],
                ...
                ConversationTurn(
                    ...
                    expected_defense=["data_exfiltration_prevention", "vault_access_control"],
            ...
            scenarios.append(ConversationScenario(
                ...
                turns=[
                    ConversationTurn(
                        ...
                        expected_defense=["anomaly_detection", "pattern_recognition"],
                        state=ConversationState.EXPLOITATION
                    )
                    for j in range(6)
                ],
...
class MultiTurnTestExecutor:
    ...
    def execute_scenario(self, scenario: ConversationScenario) -> Dict[str, Any]:
        ...
        if total_expected_defenses > 0:
            results['detection_rate'] = len(results['defenses_triggered']) / total_expected_defenses
        
        # Determine overall success
        results['overall_success'] = (
            results['attack_blocked'] and
            results['detection_rate'] >= 0.7 and
            results['turns_executed'] < scenario.total_turns
        )
        
        return results
    
    def _execute_turn(self, turn: ConversationTurn, scenario: ConversationScenario) -> Dict[str, Any]:
        ...
        if "admin" in turn.attacker_message.lower() or "password" in turn.attacker_message.lower():
...
def main():
    ...
    print(f"Defense Success Rate:   {(results_summary['successful_defenses']/results_summary['total']*100):.1f}%")
