...
# COMPLIANCE: Sovereign Substrate / test_tarl_integration.py
# ============================================================================ #
#
# COMPLIANCE: Sovereign Substrate / test_tarl_integration.py
...
class TestDiagnosticsSubsystem:
    ...
    def test_report_warning(self, diagnostics):
        ...
        diagnostics.report_warning(
            code="W001", message="Test warning", category=DiagnosticCategory.STYLE
        )
...
class TestConfigurationOverrides:
    ...
    def test_programmatic_override(self):
        ...
        overrides = {"compiler": {"debug_mode": True, "optimization_level": 0}}
    ...
    def test_system_with_config_overrides(self):
        ...
        system = TARLSystem(compiler_debug_mode=True, runtime_enable_jit=False)
        system.initialize()
